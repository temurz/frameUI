//
//  ModalAddAdmins.swift
//  frameUI
//
//  Created by Nuriddinov Subkhiddin on 26/08/25.
//

import UIKit

class ModalAddAdminsView: TemplateView {
...
extension ModalAddAdminsView: UITableViewDataSource, UITableViewDelegate {
